...
<Button color="primary" varient=""  onClick={()=>{ alert(name) }}>Click me  </Button>
    ...
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div className="mainDiv">
               ...
               <div className="">
            <button className="btn btn-sm btn-outline-success m-5"   onClick={()=>
              
               dispatch(increament()) }> Increament </button> 
                        <span> {myState} </span>   
                         <button className="btn btn-sm btn-outline-danger m-5" onClick={()=>dispatch(decrement()) } > decreament </button> 
                 </div>
